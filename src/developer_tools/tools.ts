...
class BlockInfoTool extends DevTool {
  ...
  buildSettings(settings: Settings): void {
    settings.defineProperty("name", { type: "boolean", value: true, title: "Display name" });
    settings.defineProperty("identifier", { type: "boolean", value: true, title: "Display identifier" });
    settings.defineProperty("dimension", { type: "boolean", value: true, title: "Display dimension" });
    settings.defineProperty("position", { type: "boolean", value: true, title: "Display position" });
    ...
    settings.defineProperty("states", { type: "boolean", value: true, title: "Display states" });
  }
  ...
  private render(block: Block, player: Player): void {
    ...
    if (this.store.get("name")) {
      texts.push({ rawtext: [{ text: "Name: §7" }, { translate: block.localizationKey }, { text: "§r" }] });
    }
    ...
    if (this.store.get("states")) {
      const states = Object.entries(block.permutation.getAllStates())
        ...
        .join("\n ");
      texts.push({ text: `States:\n ${states}` });
    }

    const extras = texts.flatMap((v, i) => (i === 0 ? [v] : [{ text: "\n" }, v]));
    player.onScreenDisplay.setActionBar({ rawtext: [{ text: "§lBlock Data§r\n" }, ...extras] });
  }
...
class PlayerInfoTool extends DevTool {
  ...
  constructor() {
    super(PlayerInfoTool.toolId, { name: "Player Info", description: "Displays player data in the action bar." });
  }
  ...
  buildSettings(settings: Settings): void {
    settings.defineProperty("dimension", { type: "boolean", value: true, title: "Display dimension" });
    settings.defineProperty("biome", { type: "boolean", value: true, title: "Display biome name" });
    settings.defineProperty("position", { type: "boolean", value: true, title: "Display position" });
    settings.defineProperty("position_coloring", {
      type: "boolean",
      value: true,
    ...
    settings.defineProperty("rotation", { type: "boolean", value: true, title: "Display rotation" });
    ...
    settings.defineProperty("facing_direction", { type: "boolean", value: true, title: "Display facing direction" });
    settings.defineProperty("property_size", { type: "boolean", value: true, title: "Display property size" });
    settings.defineProperty("property_count", { type: "boolean", value: true, title: "Display property count" });
  }
  ...
  private render(player: Player) {
    ...
    const extras = texts.flatMap((v, i) => (i === 0 ? [v] : [{ text: "\n" }, v]));
    player.onScreenDisplay.setActionBar({ rawtext: [{ text: "§lPlayer Data§r\n" }, ...extras] });
  }
...
class ItemInfoTool extends DevTool {
  ...
  constructor() {
    super(ItemInfoTool.toolId, { name: "Item Info", description: "Displays held item data in the action bar." });
  }
  ...
  private render(player: Player, itemStack: ItemStack): void {
    ...
    if (this.store.get("name")) {
      texts.push({ rawtext: [{ text: `Name: §7` }, { translate: itemStack.localizationKey }, { text: "§r" }] });
    }
    if (this.store.get("identifier")) {
    ...
    if (this.store.get("durability") && (durability = itemStack.getComponent("durability"))) {
      texts.push({ text: `Durability: §7${durability.damage} / ${durability.maxDurability}§r` });
    }

    let food;
    if (this.store.get("food") && (food = itemStack.getComponent("food"))) {
      texts.push({ text: `Nutrition: §7${food.nutrition}§r` });
      texts.push({ text: `Saturation Modifier: §7${food.saturationModifier.toFixed(2)}§r` });
    ...
    const extras = texts.flatMap((v, i) => (i === 0 ? [v] : [{ text: "\n" }, v]));
    player.onScreenDisplay.setActionBar({ rawtext: [{ text: "§lItem Data§r\n" }, ...extras] });
  }
  ...
  buildSettings(settings: Settings): void {
    settings.defineProperty("name", { type: "boolean", value: true, title: "Display name" });
    settings.defineProperty("identifier", { type: "boolean", value: true, title: "Display identifier" });
    settings.defineProperty("durability", { type: "boolean", value: true, title: "Display durability" });
    settings.defineProperty("food", { type: "boolean", value: true, title: "Display food" });
    settings.defineProperty("property_size", { type: "boolean", value: true, title: "Display property size" });
    settings.defineProperty("property_count", { type: "boolean", value: true, title: "Display property count" });
  }
...
class DebugModeTool extends DevTool {
  ...
  constructor() {
    super(DebugModeTool.toolId, { name: "Debug Mode", description: "Displays debug information." });
  }
}
